    ...
    <div class="tile is-child columns is-vcentered is-centered">
      <div class="column is-7 content">
        ...
        <p>
          ...
          recorded by kwzz and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in kwzz. This policy is not applicable to any
        ...
        <h2>Log Files</h2>
        <p>
          kwzz follows a standard procedure of using log files. These files log
          ...
          and the
          <NuxtLink
            to="https://www.privacypolicyonline.com/privacy-policy-generator/"
            target="_blank"
            >Online Privacy Policy Generator</NuxtLink
          >.
        </p>
        <h2>Cookies and Web Beacons</h2>
        <p>
          Like any other website, kwzz uses 'cookies'. These cookies are used to
        ...
        <p>
          ...
          advertisements and links that appear on kwzz, which are sent directly
        ...
        <p>
          Note that kwzz has no access to or control over these cookies that are
          used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          kwzz's Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          kwzz does not knowingly collect any Personal Identifiable Information
