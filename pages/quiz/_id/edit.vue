<template>
  <div class="section">
            ...
            <b-table :data="question.answers">
              <template slot-scope="props">
                ...
                <b-table-column field="delete" label="Delete" width="0" centered>
                  <span>
                    <b-button type="is-primary" outlined icon-right="minus" size="is-small"/>
                  </span>
                </b-table-column>
              </template>
              ...
              <template slot="footer">
                <div class="buttons">
                  <b-button type="is-primary" icon-right="plus" rounded outlined>Add answer</b-button>
                  <b-button type="is-primary" icon-right="minus" rounded outlined>Delete question</b-button>
                  <b-button type="is-primary" icon-right="arrow-up" rounded outlined>Move up</b-button>
                  <b-button type="is-primary" icon-right="arrow-down" rounded outlined>Move down</b-button>
                </div>
              </template>
            </b-table>
          </div>
    ...
    <div class="buttons">
      <b-button type="is-primary" icon-right="plus" rounded outlined>Add question</b-button>
      <b-button type="is-primary" icon-right="content-save" rounded outlined>Save quiz</b-button>
      <b-button type="is-primary" icon-right="eye" rounded outlined>View quiz</b-button>
      <b-button type="is-primary" icon-right="publish" rounded outlined>Publish quiz</b-button>
    </div>
  </div>
</template>
