    ...
    <div class="tile is-child columns is-vcentered is-centered">
      <div class="column is-7 content">
        ...
        <p>
          ...
          materials on kwzz's Website for personal, non-commercial transitory
        ...
        <ul>
          ...
          <li>
            attempt to reverse engineer any software contained on kwzz's
            Website;
          </li>
          <li>
        ...
        <p>
          This will let kwzz to terminate upon violations of any of these
        ...
        <h2>3. Disclaimer</h2>
        <p>
          All the materials on kwzz’s Website are provided "as is". kwzz makes
          no warranties, may it be expressed or implied, therefore negates all
          other warranties. Furthermore, kwzz does not make any representations
        ...
        <h2>4. Limitations</h2>
        <p>
          kwzz or its suppliers will not be hold accountable for any damages
          that will arise with the use or inability to use the materials on
          kwzz’s Website, even if kwzz or an authorize representative of this
        ...
        <p>
          The materials appearing on kwzz’s Website may include technical,
          typographical, or photographic errors. kwzz will not promise that any
          of the materials in this Website are accurate, complete, or current.
          kwzz may change the materials contained on its Website at any time
          without notice. kwzz does not make any commitment to update the
          materials.
        </p>
        <h2>6. Links</h2>
        <p>
          kwzz has not reviewed all of the sites linked to its Website and is
          not responsible for the contents of any such linked site. The presence
          of any link does not imply endorsement by kwzz of the site. The use of
          any linked website is at the user’s own risk.
        </p>
        <h2>7. Site Terms of Use Modifications</h2>
        <p>
          kwzz may revise these Terms of Use for its Website at any time without
        ...
        <p>
          Please read
          <nuxt-link to="/privacypolicy">our Privacy Policy</nuxt-link>.
        </p>
        <h2>9. Governing Law</h2>
        <p>
          Any claim related to kwzz's Website shall be governed by the laws of
